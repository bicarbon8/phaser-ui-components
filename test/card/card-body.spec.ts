import { CardBody, CardBodyOptions, Colors, Styles, TextButton, TextButtonOptions } from "../../src";
...
describe('CardBody', () => {
    ...
    it('can be created without options', () => {
        ...
        expect(body.width).withContext('width should be default value').toBe(defaultOpts.desiredWidth);
    ...
    it('can be created with only a title', () => {
        ...
        expect(body.contents[0].width).withContext('contents at index 0 has width greater than 0').toBeGreaterThan(0);
