import { Card, CardBodyOptions, Colors, FlexLayout, GridLayout, TextButton, TextButtonOptions } from "../src";
            ...
            contents: [
                ...
                new Card(scene, {
                    ...
                    body: CardBodyOptions.Outline.secondary({
                        ...
                        contents: [
                            scene.make.text({
                                text: 'default Aligned Card Body with FlexLayout content containing filled style TextButtons',
                                style: {
